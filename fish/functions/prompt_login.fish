function prompt_login --description 'Print a description of the user and host suitable for the prompt'
    ...
    set -l rainbow_user (echo $USER | lolcat -p 0.3)

    echo -n -s (set_color $fish_color_user) $rainbow_user (set_color normal) @ (set_color $color_host) (prompt_hostname) (set_color normal)
end
